...
const Leader = () => {
    const partners = [
        ...
        },
        {
            ...
            width: "max-w-[5rem] md:max-w-[10rem]"
        },
    ]
    ...
    return (
        <div className='flex flex-col items-center justify-center pt-40 max-w-6xl w-full mx-auto p-6'>
            ...
            >
                <div ref={div1Ref}>
                    <MagicCard className="bg-white dark:bg-background z-20 rounded-xl">
                        <div className="grid grid-cols-4 w-full items-center justify-center h-full">
                            {partners.map((partner, index) => (
                                <div
                                    key={index}
                                    className={`${partner.width} h-full mx-auto flex items-center justify-center p-4 md:p-10 ${index !== partners.length - 1 ? 'border-r' : ''}`}
                                >
                                    <Image
                                        src={partner.image}
