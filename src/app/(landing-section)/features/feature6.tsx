...
import { CirclePlay, Contact, CalendarRange, LaptopMinimalCheck, BellDot, BotMessageSquare, Plus } from "lucide-react";
    ...
    return (
        <div className="flex items-center flex-col relative w-full h-full pb-5" ref={flowContainerRef}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10 lg:gap-y-16 w-full p-4 md:p-6">
                ...
                <div className="flex justify-center">
                    <div className="bg-primary relative z-10 rounded-full p-1 scale-70 md:scale-100">
