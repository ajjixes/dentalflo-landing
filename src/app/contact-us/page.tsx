...
export default function ContactUs() {
  ...
  return (
    <div className="w-full flex flex-col items-center overflow-hidden">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 mt-16 md:mt-24">
          ...
          >
            ...
            <div className="space-y-8 mt-4">
              <div>
                ...
                <p className="opacity-80">Call us at (07) 21131176 for immediate assistance.</p>
              </div>
              
              <div>
                <h2 className="text-xl font-bold mb-2">Email</h2>
                <p className="opacity-80">Drop us an email at info@dentalfloai.com.au with your questions or requests.</p>
              </div>
              
              <div>
                <h2 className="text-xl font-bold mb-2">Business Hours</h2>
                <p className="opacity-80">We&apos;re available Monday to Friday, 9:00 AM to 5:00 PM</p>
              </div>
              
              <div>
                <h2 className="text-xl font-bold mb-2">Gold Coast Office</h2>
                <p className="opacity-80">Suite 311, 34 Glenferrie Drive,<br />Robina, Gold Coast, Qld 4226</p>
              </div>
            </div>
          </motion.div>
