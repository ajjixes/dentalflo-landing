      ...
      >
        ...
        <div className="absolute inset-0 flex scale-[0.9] items-center justify-center rounded-2xl transition-all duration-200 ease-out group-hover:scale-100">
          <div className="flex size-28 items-center justify-center rounded-full bg-primary/10 backdrop-blur-md">
            <div
              className={`relative flex size-20 scale-100 items-center justify-center rounded-full bg-primary shadow-md transition-all duration-200 ease-out group-hover:scale-[1.2]`}
            >
              <Play
      ...
      {isMounted && isVideoOpen && createPortal(
        <AnimatePresence>
          ...
          >
            ...
            >
              <motion.button 
                className="absolute -top-16 right-0 rounded-full p-2 text-xl text-white ring-1 backdrop-blur-md bg-white"
                onClick={() => setIsVideoOpen(false)}
              >
